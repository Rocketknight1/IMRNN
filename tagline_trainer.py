...
from training_functions import GetSamplesPerEpoch,ChooseCharacter,OnlineTaglineGenerator,EncodeSingleCharVec,BatchedTaglineGenerator
...
generator = BatchedTaglineGenerator(training_taglines,BATCH_SIZE,char_to_index,index_to_char,end_index)
...
while True:
	...
	generated = []
	tagline_input=np.zeros((1,1,num_chars),dtype=np.bool)
